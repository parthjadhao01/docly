...
import {
    ...
    FilePlusIcon,
    FileTextIcon,
    GlobeIcon, ItalicIcon, PrinterIcon, Redo2Icon, RemoveFormattingIcon, StrikethroughIcon,
    TextIcon,
    TrashIcon, UnderlineIcon, Undo2Icon
} from "lucide-react";
import {BsFilePdf} from "react-icons/bs";
import useEditorStore from "@/app/store/use-editor-store";
import {Avatars} from "@/app/documents/[documentId]/avatar";
                                    ...
                                    <MenubarSub>
                                        ...
                                        <MenubarSubContent>
                                            ...
                                            <MenubarItem onClick={()=>editor?.chain().focus().toggleUnderline().run()}>
                                                ...
                                                Underline
                                                <MenubarShortcut>Cmd + u</MenubarShortcut>
                                            </MenubarItem>
