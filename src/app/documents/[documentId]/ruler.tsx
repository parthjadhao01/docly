...
function Ruler() {
    ...
    return (
        <div
            ...
            >
                <Marker position={leftMargin} isLeft={true} isDragging={isDraggingLeft} onMouseDown={handleLeftMouseDown} onDoubleClick={handelLeftDoubleClick}/>
                <Marker position={rightMargin} isLeft={false} isDragging={isDraggingRight} onMouseDown={handleRightMouseDown} onDoubleClick={handelRightDoubleClick}/>
...
const Marker = ({
    ...
    return <div
        className="absolute top-0 w-4 h-full cursor-ew-resize z-[5] group -ml-5:"
